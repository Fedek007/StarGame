...
import ru.geekbrains.stargame.screen.menu.ButtonGame;
...
public class GameScreen extends Base2DScreen implements ActionListener{
    ...
    public void show() {
        ...
        buttonGame = new ButtonGame(atlas,this,BUTTON_PRESS_SCALE);
        buttonGame.setHeightProportion(BUTTON_HEIGHT);
        startNewGame();
    }
    ...
    public boolean touchDown(Vector2 touch, int pointer) {
        ...
        buttonGame.touchDown(touch,pointer);
    ...
    public boolean touchUp(Vector2 touch, int pointer) {
        ...
        buttonGame.touchUp(touch, pointer);
